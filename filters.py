# Use this to filter out words into their appropriate buckets.
# entries must be in small caps as they're normalized pre-parse.

DEFAULT = ["default", "main", "top", "bottom", "bd dx",
...
DEFAULT_ITALICS = ["italic", "internal", "innerthought", "thought", "italique"]

DEFAULT_SONG = ["op", "ed", "song", "song_lyrics", "lyricsromajibd",
        "lyrics", "op_ed", "new lyric style"]

DEFAULT_MESSENGER = ["messenger", "phone", "tweet", "cell", "messages2",
                    "messages", "bbs1", "bbs2", "darkchat"]

MODE_SIGNS = ["sign", "sfx", "eyecatch", "next_chapter", "illustration", "next ep",
